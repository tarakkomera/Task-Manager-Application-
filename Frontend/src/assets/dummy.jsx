...
// SIDEBAR 
/* Removed duplicate menuItems declaration to avoid redeclaration error */
...
export const menuItems = [
  ...
  { text: "Kanban Board", path: "/kanban", icon: <LayoutDashboard size={20} /> },
  { text: "In Progress", path: "/pending", icon: <Clock size={20} /> },
  { text: "Completed Tasks", path: "/complete", icon: <CheckCircle size={20} /> },
];
